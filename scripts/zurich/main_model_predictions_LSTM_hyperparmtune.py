...
def objective(trial):
    ...
    lstm_hidden = trial.suggest_categorical("lstm_hidden", [64, 128, 256, 512, 1024])
...
trained_model, _=train_model(model, train_loader, val_loader, optimizer, scheduler, criterion, epochs=200)
