...
from src.images_dataset import MicroscopicImagesPileaute
...
save_model_path='outputs/pileaute/model_basicautoencoder.pt'
...
### load data
base_folder = "data/pileaute/settler_filtered_data/microscope_images_CLAHE"
dataset_10x = MicroscopicImagesPileaute(root=base_folder, start_folder='2023-10-13', end_folder='2024-07-24', magnification=10, transform=None)
dataset_40x = MicroscopicImagesPileaute(root=base_folder, start_folder='2023-10-13', end_folder='2024-07-24', magnification=40, transform=None)
...
visualize_reconstruction(model, DEVICE, val_loader, num_images=5, path='outputs/pileaute/validationdataset_reconstruction.png')
...
dst_folder = 'outputs/pileaute/all_images_encoded'
shutil.copytree(src_folder, dst_folder)

dataset_10x = MicroscopicImagesPileaute(root=dst_folder, start_folder='2023-10-13', end_folder='2025-02-19', magnification=10, transform=None)
dataset_40x = MicroscopicImagesPileaute(root=dst_folder, start_folder='2023-10-13', end_folder='2025-02-19', magnification=40, transform=None)
